...
\begin{figure}[htbp]
    \centering
    \subfloat[$1^{st}$ landmark (the best case)]{\label{}\includegraphics[width=0.49\textwidth]{images/charts/fs_lm1.png}}~~
    \subfloat[$6^{th}$ landmark (the worst case)]{\label{}\includegraphics[width=0.49\textwidth]{images/charts/fs_lm6.png}}\\
    \subfloat[$1^{st}$ landmark]{\label{}\includegraphics[width=0.49\textwidth]{images/charts/fn_lm7.png}}~~
    \subfloat[$6^{th}$ landmark (the worst case)]{\label{}\includegraphics[width=0.49\textwidth]{images/charts/fn_lm6.png}}
