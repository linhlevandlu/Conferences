...
As we have presented, a CNN architecture contains several type of layers. 
The implementation of a CNN model usually begins with classical architecture which consists of some classical layers like convolutional layers, pooling layers or fully connected layers (e.g LeNet).
