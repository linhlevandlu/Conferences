...
it seems that the proposed architecture provides more accurate predictions on the elytra dataset, but the results are opposite on other datasets.
...
\begin{figure}[htbp]
    ...
    \caption{The distance between manual landmarks and predicted landmarks of an image when applying different techniques of each beetle's anatomical }
    \label{figmn5parts}
\end{figure}
