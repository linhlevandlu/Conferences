...
%\title{Applying fine-tuning to detect the landmarks on biological images}
...
\address{LaBRI - Bordeaux Univeristy, France/ Dalat University, Vietnam}
        {van-linh.le@labri.fr/linhlv@dlu.edu.vn}
\address{LaBRI - CNRS 5800 Bordeaux University, France}
        {beurton@labri.fr}  
\address{LaBRI - CNRS 5800 Bordeaux University, France}
		{zemmari@labri.fr}     
\address{IGEPP - INRA 1349, Rennes, France}
