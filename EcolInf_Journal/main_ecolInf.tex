...
\author[labri]{Le Van Linh\corref{cor1}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.75\textwidth]{images/face_dataset_2}
...
The results have been evaluated by calculating the distance between manual landmarks and predicted ones. These results have shown that using CNN to predict the landmarks on biological images leads to satisfying results without need for segmentation step on the studied objects. These results have been valided by biologists that our model could be used to replace the manual task.
